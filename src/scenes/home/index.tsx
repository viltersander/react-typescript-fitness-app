...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 pt-12 md:h-full md:pb-0">
        ...
        onViewportEnter={() => setSelectedPage(SelectedPage.Home)}>
            ...
            <div className="z-10 mt-20 sm:mt-32 md:basis-3/5">
                ...
                {/* ACTIONS */}
                <motion.div className="mt-8 flex items-center gap-8" initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.5 }}
        ...
        {isAboveMediumScreens && (
            <div className="h-[150px] w-full bg-primary-100 py-10">
                <div className="mx-auto w-5/6">
                    <div className="flex w-2/5 items-center justify-between gap-8">
